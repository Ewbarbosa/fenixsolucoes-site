      ...
      <div className={style.content}>
        ...
        <div className={style.contentBody}>
          ...
          <article>
            ...
            <br /><br />Entre em contato conosco hoje mesmo para descobrir como a Fenix Soluções Inteligentes pode ajudar a transformar sua empresa por meio da automação comercial.
            Estamos ansiosos para colaborar com você na busca de resultados excepcionais.
          </article>
        </div>
